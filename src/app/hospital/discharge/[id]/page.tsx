...
export default function DischargePlanDetailPage() {
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={`Patient: ${plan.patient.name}`}
        backHref={`/hospital/patients/${plan.patient.id}`}
      />
      ...
      <Card className="mb-4">
        ...
        <CardContent className="space-y-3">
          <div>
            ...
            <div className="text-sm font-medium">{plan.diagnosis}</div>
          </div>
          <div>
            <div className="text-xs font-medium text-muted-foreground mb-1">
              Instructions
